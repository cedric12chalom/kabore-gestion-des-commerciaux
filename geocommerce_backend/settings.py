"""
Django settings for ISJ_L2_PROJET-TUTORE_GROUPE-6 project.
...
SECRET_KEY = 'django-insecure-ic8=osqv2fm5np)397ob3q!e^plv-s5e*1e#ujrvn+saz!ae8n'
...
# Authentication - Allow login with email
